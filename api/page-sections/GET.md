...
**Operation ID:** PageSectionPublicController_getPageSections
**Tags:** PageSectionPublic
**Security:** none

> Get all active sections of a page by page id or entity
...
| --- | --- | --- | --- | --- |
| query | id | no | number | Page id. Takes precedence over entityType when provided. |
| query | entityType | no | string |  |
| query | entityId | no | number | Entity id used together with entityType. |
...
**Description:** Page with its active sections
...
**Description:** Neither id nor entityType provided
