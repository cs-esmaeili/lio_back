...
- **صفحه‌بندی ندارد**؛ کل لیست (حدود ۱۲۴۰ لوکیشن در ۳۱ استان) را یک‌جا برمی‌گرداند. برای فرم انتخاب استان/شهر کافی است؛ بهتر است یک‌بار بگیر و cache کن و روی `province` گروه‌بندی کن.
