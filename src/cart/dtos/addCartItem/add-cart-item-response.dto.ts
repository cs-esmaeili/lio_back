...
export class AddCartItemProductDto {
...
export class AddCartItemVariantDto {
...
export class AddCartItemItemDto {
  ...
  @ApiProperty({ type: AddCartItemProductDto })
  product!: AddCartItemProductDto;

  @ApiProperty({ type: AddCartItemVariantDto })
  variant!: AddCartItemVariantDto;
}

export class AddCartItemResponseDto {
  @ApiProperty({ type: [AddCartItemItemDto] })
  items!: AddCartItemItemDto[];
